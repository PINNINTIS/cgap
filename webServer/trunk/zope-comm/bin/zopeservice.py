...
PYTHON = r'/usr/local/python-2.4.5/bin/python'
SOFTWARE_HOME=r'/usr/local/zope-2.9.11/lib/python'
INSTANCE_HOME = r'/usr/local/zope-2.9.11/zope-comm'
ZOPE_HOME = r'/usr/local/zope-2.9.11'
