...
use constant CACHE_DK_EXIST_ROOT     => INIT_DATA_HOME . "DK_cache/";
...
use constant GENOMICS_CACHE_PREFIX   => "GENOMICS";
use constant DK_CACHE_PREFIX         => "DK";
use constant UPLOAD_CACHE_PREFIX     => "UPLOAD";
