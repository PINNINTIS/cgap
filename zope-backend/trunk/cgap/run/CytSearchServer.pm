...
sub DoGenePile_for_Gene_info {
  ...
  if (@positive_terms > 0) {
    ...
    $s = $s . "(k.gene like '$gene/%' or k.gene like '%/$gene')";
    if ($suffix) {
      $s = $s . " and k.suffix = '$suffix'";
    } 
    ...
    for ($i = 1; $i < @positive_terms; $i++) {
      ...
      if ($log_op eq "a") {
        ...
        $s = $s . "(k$i.gene like '%$gene/' or k$i.gene like '%/$gene')";
        if ($suffix) {
          $s = $s . " and k$i.suffix = '$suffix'";
        } 
        $s = $s . ")";
...
sub  BuildFullSearchNewInterface {
  ...
  my ($checked_a, $checked_b, $checked_c, $checked_d, %checked_race, %checked_immuno, $page_new_value, $link_name, $link_1, $link_2, $link_3, $link_4, $link_5);
  my $html = 
       ...
       "<input type=hidden name=\"country_size\" value=$country_size>" .
       ...
       "   </td>" .
       "</tr>"; 
       if( $page == 7 || $country_size == 40 ) {
         $link_1 =
            "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.country_size.value=5;document.pform.page.value=8;document.pform.submit()\">" .
            "Collapse Country List</a>";
       }
       elsif( $page == 8 || $country_size == 5 ) {
         $link_1 = 
            "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.country_size.value=40;document.pform.page.value=7;document.pform.submit()\">" .
            "Expand Country List</a>";
       }
       $html = $html .
       "<tr>" .
       ...
       if( $page == 7 || $country_size == 40 ) {
         $html = $html .
            "<select name=country id=\"country\" size=40 multiple>"; 
       }
       elsif( $page == 8 || $country_size == 5 ) {
          $html = $html .
       ...
       $html = $html .
           GetSelectMenu_2('MITELMAN_COUNTRY', $country) .
       ...
       "         <option value=\"S\" $checked_b>Selected</option>" .
       "         <option value=\"U\" $checked_c>Unselected</option>" .
       "      </select>" .
       "   </td>" .
       "</tr>" .
       "<tr>" .
       ...
       "   </td>" .
       "   <td>" .
             GetSelectMenu_3('MITELMAN_HERDIS', $herdis) .
       "   </td>" .
       "</tr>" .
       "<tr>" .
       "   <td valign=top align=right>" .
       "      <label for=\"specherdis\">" .
       "<a href=javascript:spawn(\"/Chromosomes/HelpLists?FIELDNAME=specherdis&TABLENAME=cytogen\")>Special Hereditary Disorder:" .
       "</A>" .
       "</label>" .
       "   </td>" .
       "   <td>" .
       "      <input type=\"text\" name=\"specherdis\" id=\"specherdis\" value=\"$specherdis\" size=32 maxlength=50>" .
       "   </td>" .
       "</tr>" .
       "</table>" .
       "<P>" .
       "<b>Present Tumor</b> " .
       "<table border=0 cellpadding=3 cellspacing=4 width=\"100%\">"; 
       if( $page == 9 || $top_size == 40 ) {
         $link_2 = 
             "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.top_size.value=5;document.pform.page.value=10;document.pform.submit()\">" .
             "Collapse Topography List</a>";
       }
       elsif( $page == 10 || $top_size == 5 ) {
         $link_2 =
             "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.top_size.value=40;document.pform.page.value=9;document.pform.submit()\">" .
             "Expand Topography List</a>";
       }
       $html = $html .
         "<tr>" .
         "<td valign=top align=right width=25% nowrap>" .
         "<label for=\"present_topography\">Topography:</label>" .
         "   <br>" .
         $link_2 .
         "</td>" .
         "<td valign=top>";
      ...
      $html = $html .
         ...
         "   </td>" .
         "   <td>"; 
       undef %checked_immuno;
       my @immunos = split ",", $immuno;
       for( my $i=0; $i<@immunos; $i++ ) {
         $checked_immuno{$immunos[$i]} = "checked";
       }

       $html = $html .
         "<input type=\"checkbox\" name=\"immuno\" id=\"B_Lineage\" value=\"B\" $checked_immuno{B}>" .
         "<label for=\"B_Lineage\">B Lineage</label><BR>" .
   ####       "<!--      <input type=\"checkbox\" name=\"immuno\" value=\"N\">N</font> &nbsp;&nbsp;&nbsp;&nbsp;-->" .
         "<input type=\"checkbox\" name=\"immuno\" id=\"T_Lineage\" value=\"T\" $checked_immuno{T}>" .
         "<label for=\"T_Lineage\">T Lineage</label>" .
         "   </td>" .
         "</tr>"; 
       if( $page == 11 || $morph_size == 40 ) {
         $link_3 = 
           "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.morph_size.value=5;document.pform.page.value=12;document.pform.submit()\">" . 
           "Collapse Morphology List</a>";
       }
       elsif( $page == 12 || $morph_size == 5 ) {
         $link_3 = 
           "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.morph_size.value=40;document.pform.page.value=11;document.pform.submit()\">" .
           "Expand Morphology List</a>";
       }
       $html = $html .
         "<tr>" .
         "   <td valign=top align=right>" .
         "      <label for=\"present_morphology\">Morphology:</label>" .
         "  <br> " .
         $link_3 .
         "   </td>" .
         "   <td>";
       if( $page == 11 || $morph_size == 40) {
         $html = $html .
         "<select name=morph id=\"present_morphology\" size=40 multiple>";
       }
       elsif( $page == 12 || $morph_size == 5 ) {
         $html = $html .
       ...
       "</tr>" .
       "<tr>" .
       "   <TD><label for=\"specmorph\"><a href=javascript:spawn(\"/Chromosomes/HelpLists?FIELDNAME=specmorph&TABLENAME=cytogen\")>Special Morphology:</A></label>" .
       "      </td>" .
       "   </td>" .
       "   <td>" .
       ...
       "         <option value=\"\">[Any]</option>" .
                 GetSelectMenu_2('MITELMAN_TISSUE', $tissue) .
       "      </select>" .
       "   </td>" .
       "</tr>" .
       "</table>" .
       ...
       $html = $html .
       " <input type=\"radio\" name=\"prevneo\" id=\"Any\" value=\"\" $checked_a>" .
       "      <label for=\"Any\">Any</label><BR>" .
       " <input type=\"radio\" name=\"prevneo\" id=\"Yes\" value=\"Y\" $checked_b>" .
       "      <label for=\"Yes\">Yes</label><BR>" .
       " <input type=\"radio\" name=\"prevneo\" id=\"No_Unknown\" value=\"N\" $checked_c>" .
       "      <label for=\"No_Unknown\">No/Unknown</label> " .
       "   </td>" .
       "</tr>"; 

       if( $page == 13 || $prevtop_size == 40 ) {
         $link_4 = 
            "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.prevtop_size.value=5;document.pform.page.value=14;document.pform.submit()\">" .
            "Collapse Topography List</a>";
       }
       elsif( $page == 14 || $prevtop_size == 5 ) {
         $link_4 = 
            "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.prevtop_size.value=40;document.pform.page.value=13;document.pform.submit()\">" .
            "Expand Topography List</a>";
       }
       $html = $html .
         "<tr>" .
         "<td valign=top align=right width=25%i nowrap>" .
         ...
         if( $page == 13 || $prevtop_size == 40 ) {
           $html = $html .
              "<select name=prevtop id=\"Topography\" size=\"40\" multiple>";
         }
         elsif( $page == 14 || $prevtop_size == 5 ) {
           $html = $html .
      ...
      $html = $html .
         GetSelectMenu_2('MITELMAN_TOP', $prevtop) .
         "</select> " .
         "</td>" .
         "</tr>"; 
       if( $page == 15 || $prevmorph_size == 40 ) {
         $link_5 =
           "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.prevmorph_size.value=5;document.pform.page.value=16;document.pform.submit()\">" .
           "Collapse Morphology List</a>";
       }
       elsif( $page == 16 || $prevmorph_size == 5 ) {
         $link_5 = 
           "<a href=\"javascript:document.pform.action='CytSearchFormForDiffMenu';document.pform.prevmorph_size.value=40;document.pform.page.value=15;document.pform.submit()\">" .
           "Expand Morphology List</a>";
       }
       $html = $html .
         "<tr>" .
       ...
       if( $page == 15 || $prevmorph_size == 40) {
         $html = $html .
         "<select name=prevmorph id=\"morphology\" size=40 multiple>";
       }
       elsif( $page == 16 || $prevmorph_size == 5 ) {
         $html = $html .
       ...
       $html = $html .
         GetSelectMenu_2('MITELMAN_MORPH', $prevmorph) .
       ...
       "         <option value=\"\">[Any]</option>" .
                 GetSelectMenu_2('MITELMAN_TREAT', $treat) .
       "      </select>" .
       "   </td>" .
       "</tr>" .
       "</table>" .
       ...
       "   </td>" .
       "   <td><input type=\"text\" name=\"author\" id=\"Authors\" value=\"$author\" size=30 maxlength=80>" .
       "   </td>" .
       "</tr>" .
       "<tr>" .
       "   <td valign=top align=right>" .
       ...
       "   </td>" .
       "   <td>" .
       "      <input type=\"text\" name=\"journal\" id=\"Journal\" value=\"$journal\" size=30 maxlength=80 >" .
       "   </td>" .
       "</tr>" .
       "<tr>" .
       "   <td valign=top align=right>" .
       ...
       "   </td>" .
       "   <td>" .
       "      <input type=\"text\" name=\"year\" id=\"Year\" value=\"$year\" size=10 maxlength=11>" .
       "   </td>" .
       "</tr>" .
       "" .
       "<tr><TD valign=top>" .
       ...
       "        <TD><input type=\"text\" name=\"refno\" id=\"refno\" value=\"$refno\" size=5 maxlength=5></TD>" .
       "    </TR>" .
       "    <TR>" .
       "       <TD valign=top><label for=\"caseno\">Case No.</label></TD>" .
       "       <TD><input type=\"text\" name=\"caseno\" id=\"caseno\" value=\"$caseno\" size=5 maxlength=5></TD>" .
       "    </TR>" .
       "    <TR><td valign=top><label for=\"invno\">Inv. No.</label></TD>" .
       "        <TD><input type=\"text\" name=\"invno\" id=\"invno\" value=\"$invno\" size=5 maxlength=5></TD>" .
       "    </TR>" .
       "  </Table>" .
       "   </td>" .
       "</tr>" .
       ...
       "  <input type=button value=\"Reset Form\" onClick=\"parent.location='/Chromosomes/CytSearchForm'\">" .
       "  </TD>" .
       "</TR>" .
       "</table>" .
       "</form>"; 
...
sub  BuildNewInterface {
  ...
  my ($checked_a, $checked_b, $page_new_value, $link_url, $link_name);
  my $html = "<H3>Mitelman Cases Quick Searcher</H3>" .
             ...
             $html = $html .
               ...
               "   </td>" .
               "</tr>" .
               "<tr><td &nbsp;></td><td colspan=2><input type=submit> or <input type=button value=\"Reset Form\" onClick=\"parent.location='/Chromosomes/AbnCytSearchForm'\">" .
               "</td>" .
               "</table>" .
               "</form>"; 
##        "<blockquote>" .
...
sub  BuildNewInterface_MSearch {
  ...
  my ($checked_a, $checked_b, $page_new_value, $link_url, $link_name, $link_gene);
  my ($checked_c, $checked_d, %checked_race, %checked_immuno);
  my $html = 
             "<H3>The Mitelman Molecular Biology Associations Searcher</H3> " .
             "<form name=\"pform\" method=\"POST\" action=\"MCList\"> " .
             "<input type=hidden name=\"morph_size\" value=$morph_size>" .
             "<input type=hidden name=\"top_size\" value=$top_size>" .
             "<input type=hidden name=\"gene_size\" value=$gene_size>" .
             "<Blockquote> " .
             "The Molecular Biology Associations Searcher finds " .
             "Molecular biology associations that relate chromosomal aberrations and tumor histologies to  " .
             "genomic sequence data, typically genes rearranged as a consequence of structural  " .
             "chromosome changes.                  " .
             " " .
             "</blockquote> " .
             " " .
             ...
             "<tr> " .
             "   <td bgcolor=\"#38639d\"> " .
             "      <font color=\"white\"><b>Molecular Biology Associations Searcher</b></font> " .
             "   </td> " .
             "</tr> " .
             "</table> " .
             " " .
             "<blockquote> " .
             "Brief instructions for using the Molecular Biology Associations Searcher: " .
             "<UL><LI>Select an Association. " .
             "<LI>Complete as many of the fields following as required. " .
             "<LI>The default setting for both Topography and Morphology is all items. Or highlight  " .
             "single or multiple items. " .
             "<li>Any section may be left blank. " .
             "<LI>Press Submit Query, or Reset to begin a new search. " .
             "</UL> " .
             "</blockquote> " .
             " " .
             ...
             "<table width=100% cellpadding=4> " .
             " " .
             "<TR><td valign=top align=right width=25%> " .
             "      Abnormality: " .
             "   </td> " .
             "   <td> ";
             $checked_a = ($abnorm_op eq "a" ? "checked" : ""); 
             ...
             "      <label for=\"Or\"> Or</label> " .
             "   <br> " .
             "      <label for=\"abnormality\"></lable> " .
             "   <input type=\"text\" name=\"abnormality\" id=\"abnormality\" size=32 maxlength=50> " .
             "   </td> " .
             "</tr> " .
             "<tr> " .
             "   <td valign=top align=right> " .
             ...
             "      <input type=\"text\" name=\"breakpoint\" id=\"breakpoint\" size=32 maxlength=50> " .
             "   </td> " .
             "</tr> " .
             "</table> " .
             " " .
             "<P><B>Gene Characteristics</B> " .
             "<table width=100% cellpadding=4> " .
             " <tr> " .
             "   <td valign=top align=right width=25%> " .
             "      Gene: " .
             ...
             $checked_a = "";
             $checked_b = "";
             $checked_a = ($gene_op eq "a" ? "checked" : ""); 
             $checked_b = ($gene_op eq "o" ? "checked" : ""); 
             $html = $html . 
             "   <td align=left> " .
             "      <input type=radio name=gene_op id=\"And\" value=\"a\" $checked_a> " .
             "      <label for=\"And\"> And</label> " .
             "      <input type=radio name=gene_op id=\"Or\" value=\"o\" $checked_b> " .
             "      <label for=\"Or\"> Or</label> " .
             "      <label for=\"Gene\"></label> " .
             "   </td> " .
             "   </tr> ";
             if( $page == 59 || $gene_size == 40 ) {
               $link_gene =
                  ## "Expand Gene List<br>" .
                  ## "With Gene Name <br> " .
                  ...
                  ## "<br>" .
                  ## "<br>" .
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.gene_size.value=5;document.pform.page.value=60;document.pform.submit()\">" .
                  "Collapse Gene List</a>";
             }
             elsif( $page == 60 || $gene_size == 5 ) {
               $link_gene =
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.gene_size.value=40;document.pform.page.value=59;document.pform.submit()\">" .
                  "Expand Gene List</a>";
                  ## "Expand Gene List<br>" .
                  ## "With Gene Name <br> " .
                  ## "Leading Character<br>" .
             ...
             if( $page == 59 || $gene_size == 40 ) {
               $html = $html .
                 "<select name=gene id=\"gene\" size=\"40\" multiple>";                  }
             elsif( $page == 60 || $gene_size == 5 ) {
               $html = $html .
                 "<select name=gene id=\"gene\" size=\"5\" multiple>";
             }
             $html = $html .
                GetSelectMenu_4('MolGeneList', $gene) .
             "</select> " .    
             "</td>" .
             "</tr></table> " .
             "<P><B>Tumor Characteristics</B> " .
             " " .
             "     " .
             " " .
             "<table width=100% cellpadding=4> ";
             if( $page == 17 || $top_size == 40 ) {
               $link_url =
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.top_size.value=5;document.pform.page.value=18;document.pform.submit()\">" .
                  "Collapse Topography List</a>";
             }
             elsif( $page == 18 || $top_size == 5 ) {
               $link_url =
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.top_size.value=40;document.pform.page.value=17;document.pform.submit()\">" .
                  "Expand Topography List</a>";
             }
             $html = $html .
             "<tr> " .
             ...
             "</td>" .
             "</tr>";
             if( $page == 19 || $morph_size == 40 ) {
               $link_name =
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.morph_size.value=5;document.pform.page.value=20;document.pform.submit()\">" .
                  "Collapse Morphology List</a>";
             }
             elsif( $page == 20 || $morph_size == 5 ) {             
                $link_name =             
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.morph_size.value=40;document.pform.page.value=19;document.pform.submit()\">" .                         "Expand Morphology List</a>";
             }
           ...
           $html = $html .
             "      <input type=\"checkbox\" name=\"immuno\" id=\"B_Lineage\" value=\"B\" $checked_immuno{B}> " .
             "      <label for=\"B_Lineage\">B Lineage</label><BR> " .
             ## "<!--      <input type=\"checkbox\" name=\"immuno\" value=\"N\">N &nbsp;&nbsp;&nbsp;&nbsp;--> " .
             "      <input type=\"checkbox\" name=\"immuno\" id=\"T_Lineage\" value=\"T\" $checked_immuno{T}> " .
             "      <label for=\"T_Lineage\">T Lineage</label> " .
             "   </td> " .
             "</tr></table> " .
             ...
             "   </td> " .
             "   <td> " .
             "      <input type=\"text\" name=\"author\" id=\"Authors\" value=\"$author\" size=30 maxlength=80> " .
             "   </td> " .
             "</tr> " .
             "<tr> " .
             "   <td align=right> " .
             ...
             "<tr> " .
             "   <td valign=top> " .
             "     <table align=right><tr><Td align=right>Specific ID Number:</TD></TR></table> " .
             "   </td> " .
             "   <td><table><tr><TD valign=top><label for=\"refno\">Ref. No.</label>" .
             "  </TD><TD><input type=\"text\" name=\"refno\" id=\"refno\"  value=\"$refno\" size=5 maxlength=5></TD></TR> " .
             "      <TR><TD valign=top><label for=\"invno\">Inv. No.</label></TD><TD> " .
             "      <input type=\"text\" name=\"invno\" id=\"invno\" value=\"$invno\" size=5 maxlength=5> " .
             "      </TD></TR></table> " .
             "   </td> " .
             "</tr> " .
             "<TR><TD> &nbsp; </TD><TD><input type=hidden name=\"page\" value=1> " .
             "<input type=submit> or " . 
             "<input type=button value=\"Reset Form\" onClick=\"parent.location='/Chromosomes/MSearchForm'\">" . 
             "</table> " .
             "</form> " .
             "<blockquote> " .
             "<dtml-var Yellow> " .
...
sub  BuildNewInterface_CSearch {
  ...
  my ($checked_c, $checked_d, %checked_race, %checked_immuno);
  my $html =
             "<H3>The Mitelman Clinical Associations Searcher</H3> " .
             "<form name=\"pform\" method=\"GET\" action=\"MCList\"> " .
             "<input type=hidden name=\"morph_size\" value=$morph_size>" .
             "<input type=hidden name=\"top_size\" value=$top_size>" .
             "<input type=hidden name=\"gene_size\" value=$gene_size>" .
             "<Blockquote> " .
             "The Clinical Associations Searcher finds " .
             "Clinical associations that relate chromosomal aberrations and/or gene rearrangements and  " .
             "tumor histologies to clinical variables, such as prognosis, tumor grade, and patient  " .
             "characteristics.    " .
             " " .
             "</blockquote> " .
             " " .
             ...
             "<tr> " .
             "   <td bgcolor=\"#38639d\"> " .
             "      <font color=\"white\"><b>Clinical Associations Searcher</b></font> " .
             "   </td> " .
             "</tr> " .
             "</table> " .
             " " .
             "<blockquote> " .
             "Brief instructions for using the Clinical Associations Searcher: " .
             "<UL><LI>Select an Association. " .
             "<LI>Complete as many of the fields following as required. " .
             "<LI>The default setting for both Topography and Morphology is all items. Or highlight  " .
             "single or multiple items. " .
             ...
             $html = $html .
             "      <input type=radio name=break_op id=\"And\" value=\"a\" $checked_a><label for=\"And\"> And</label> " .
             "      <input type=radio name=break_op id=\"Or\" value=\"o\" $checked_b><label for=\"Or\"> Or</label> " .
             "   <br> " .
             "      <input type=\"text\" name=\"breakpoint\" id=\"breakpoint\" size=32 maxlength=50> " .
             "   </td> " .
             "</tr> " .
             ...
             if( $page == 79 || $gene_size == 40 ) {
               $link_gene =
                  ...
                  ## "<br>" .
                  ## "<br>" .
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.gene_size.value=5;document.pform.page.value=80;document.pform.submit()\">" .
                  "Collapse Gene List</a>";             
             }
             elsif( $page == 80 || $gene_size == 5 ) {
               $link_gene =                  
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.gene_size.value=40;document.pform.page.value=79;document.pform.submit()\">" .
                  "Expand Gene List</a>";
                  ## "Expand Gene List<br>" .
                  ## "With Gene Name <br> " .
                  ## "Leading Character<br>" .
             ...
             $html = $html .
                GetSelectMenu_4('ClinGeneList', $gene) .
             "</select> " .
             "</td>" .
             "</tr></table> " .
             "<P><B>Tumor Characteristics</B> " .
             "<table width=100% cellpadding=4> ";
             if( $page == 21 || $top_size == 40 ) {
               $link_url =
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.top_size.value=5;document.pform.page.value=22;document.pform.submit()\">" .
                  "Collapse Topography List</a>";
             }
             elsif( $page == 22 || $top_size == 5 ) {
               $link_url =
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.top_size.value=40;document.pform.page.value=21;document.pform.submit()\">" .
                  "Expand Topography List</a>";
             }
             $html = $html .
             "<tr> " .
             ...
             "</td>" .
             "</tr>";
             if( $page == 23 || $morph_size == 40 ) {
               $link_name =
                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.morph_size.value=5;document.pform.page.value=24;document.pform.submit()\">" .
                  "Collapse Morphology List</a>";
             }
             elsif( $page == 24 || $morph_size == 5 ) {
                $link_name =                  "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.morph_size.value=40;document.pform.page.value=23;document.pform.submit()\">" .                         "Expand Morphology List</a>";
             }
           ...
           $html = $html .
             ...
             "</tr>" .
             "<tr>" .
             "   <td valign=top align=right> " .             "      Immunophenotype: " .
             "   </td> " .
             "   <td> ";
             undef %checked_immuno;
             my @immunos = split ",", $immuno;
             for( my $i=0; $i<@immunos; $i++ ) {               $checked_immuno{$immunos[$i]} = "checked";
             }
           ...
           $html = $html .
             ...
             "<TR><TD> &nbsp; </TD><TD><input type=hidden name=\"page\" value=1> " .
             "<input type=submit> or " .
             "<input type=button value=\"Reset Form\" onClick=\"parent.location='/Chromosomes/CSearchForm'\">" .
             "</table> " .
             "</form> " .
             "<blockquote> " .
             "<dtml-var Yellow> " .
...
sub Build_new_RCA_form_1 {
  ...
  my ($checked_a, $checked_b, $page_new_value, $link_1, $link_2, $link_3);
  my ($checked_c, $checked_d, %checked_race, %checked_immuno);
  my ($checked_type_1, $checked_type_2, $checked_type_3);
  my ($checked_n_type_1, $checked_n_type_2, $checked_n_type_3);

  my $html = 
        "<h3>Recurrent Chromosome Aberrations in Cancer</h3> " .
        "<blockquote> " .
        "The recurrent aberrations were derived from the Mitelman Database of Chromosome  " .
        "Aberrations and Gene Fusions in Cancer and include all cytogenetic changes  " .
        ...
        "<a href=Mitelman>Mitelman Database of Chromosome Aberrations and Gene Fusions in Cancer</a>.  " .
        " " .
        "<P>An earlier version of this survey appeared in the April 1997  " .
        "Special Issue of Nature Genetics, entitled:  " .
        "<a href=\"http://www.ncbi.nlm.nih.gov/htbin-post/Entrez/query?uid=9140409&form=6&db=m&Dopt=b\"> " .
        "A genome-wide map of chromosomal breakpoints in human cancer</A>. Here, CGAP provides " .
        ...
        "   <td bgcolor=\"#38639d\"> " .
        "      <font color=\"white\"><b> " .
        "The Recurrent Chromosome Aberrations in Cancer Database Searcher</b></font> " .
        "   </td> " .
        "</table> " .
        "<blockquote>  " .
        "<UL><LI>Brief instructions for searching the database: " .
        "     <UL><LI>You must choose one or both " .
        "             of the following two fields: " .
        "             Structural Aberrations and Numerical Aberrations. " .
        "         <LI>If you choose Structural Aberrations, you must select at least one of " .
        "             the following fields: " .
        "             Breakpoint, Topography, Morphology, or Gene. " .
        "         <LI>If you choose Numerical Aberrations, you must select at least " .
        "             one of the following fields: " .
        "             Chromosome, Topography, Morphology.     " .
        "         <li>You may select only one item in each pulldown menu " .
        "         <li>Press Retrieve. " .
        "    </ul> " .
        " " .
        "<LI>A successful search returns a table, with the following headings and entries: " .
        "  <UL><LI>Breakpoint, with each entry linked to the OMIM Gene Map " .
        "          (this column is returned only for structural aberrations) " .
        "      <LI>Abnormality " .
        "      <LI>Morphology, with each entry linked to a similar  " .
        "          table that describes all abnormalities with this morphology. " .
        "      <LI>Topography, with each entry linked to a similar  " .
        "          table that describes all abnormalities at this topography    " .
        "      <LI>Number of cases, hyperlinked to the list of applicable cases " .
        "      <LI>Genes " .
        "  </UL> " .
        "  " .
        "</ul> " .
        "</blockquote> " .
        " " .
        "<FORM name=\"pform\" ACTION=\"Mitel_Search#MARK\" METHOD=\"POST\"> " .
        " " .
        "<input type=hidden name=\"morph_size\" value=\"$morph_size\"> " .
        "<input type=hidden name=\"top_size\" value=\"$top_size\"> " .
        "<input type=hidden name=\"gene_size\" value=\"$gene_size\"> " .
        " " .
        "<blockquote>  " .
        "<P><TABLE BORDER=\"0\" WIDTH=\"100%\" cellpadding=6\"> " .
        "   <tr> " .
        "      <td valign=top><b><font size=3><label for=\"Structural_aberrations\">Structural aberrations:</label></font></b> " .
        "      </td> " .
        "      <td valign=top><b><font size=3><label for=\"Numerical_aberrations\">Numerical aberrations:</label></font></b> " .
        "      </td>  " .
        "   </tr>  ";
        $checked_a = "";
        $checked_b = "";
     ...
     $html = $html .
        "   <tr> " .
        "      <td> " .
        "         <input type=\"checkbox\" name=\"structural\" id=\"Structural_aberrations\" $checked_a> " .
        "      </td> " .
        "      <td> " .
        "         <input type=\"checkbox\" name=\"numerical\" id=\"Numerical_aberrations\" $checked_b> " .
        "      </td>  " .
        "   </tr>      " .
        "  " .
        "   <tr> " .
        "      <td valign=top><b><label for=\"Breakpoint\">Breakpoint:</label></b>  " .
        "      </td> " .
        "      <td valign=top><b><label for=\"Chromosome\">Chromosome:</label></b>  " .
        "      </td> " .
        "   </tr> " .
        "   <tr> " .
        "      <td> " .
        "         <input type=\"text\" name=\"breakpoint\" id=\"Breakpoint\" value=\"$breakpoint\" size=5 maxlength=5> " .
        "      </td> " .
        "      <td> " .
        "         <input type=\"text\" name=\"chromosome\" id=\"Chromosome\" value=\"$chromosome\" size=2 maxlength=2> " .
        "      </td> " .
        "   </tr>    " .
        "   <tr> " .
        "     <TD valign=top> " .
        "         <b>Aberration type:</b><br> " .
        "     </TD> " .
        "     <TD valign=top> " .
        "         <b>Aberration type:</b><br> " .
        "     </TD> " .
        ...
        $checked_type_3 = ""; 
        if( $type =~ /Both/ ) {
          $checked_type_1 = "selected"; 
        }
        elsif( $type =~ /Balanced/ ) {
          $checked_type_2 = "selected";
        }
        elsif( $type =~ /Unbalanced/ ) {
          $checked_type_3 = "selected";
        }
        $checked_n_type_1 = ""; 
        $checked_n_type_2 = ""; 
        $checked_n_type_3 = ""; 
        if( $num_type =~ /Both/ ) {
          $checked_n_type_1 = "selected"; 
        }
        elsif( $num_type =~ /Trisomy/ ) {
          $checked_n_type_2 = "selected";
        }
        elsif( $num_type =~ /Monosomy/ ) {
          $checked_n_type_3 = "selected";
        }
     $html = $html .
        "   <TR> " .
        "     <TD> " .
        ...
        "         <option value=\"Both\" $checked_type_1>All</option> " .
        "         <option $checked_type_2>Balanced          </option> " .
        "         <option $checked_type_3>Unbalanced &nbsp;&nbsp;&nbsp;&nbsp;</option> " .
        "       </select> " .
        "     </TD> " .
        "     <TD> " .
        "       <label for=\"num_type\"></label> " .
        "       <select name=\"num_type\" id=\"num_type\" size=\"3\"> " .
        "         <option value=\"Both\" $checked_n_type_1>All</option> " .
        "         <option $checked_n_type_2>Trisomy         </option> " .
        "         <option $checked_n_type_3>Monosomy &nbsp;&nbsp;&nbsp;&nbsp;</option> " .
        "       </select> " .
        "     </TD> " .
        "   </tr> " .
        "</TABLE> " .
        ...
        if( $page == 3 || $top_size == 40 ) {
          $link_1 =
             "<a href=\"javascript:document.pform.action='RCASearchFormForDiffMenu';document.pform.top_size.value=5;document.pform.page.value=4;document.pform.submit()\">Collapse Topography List:</A> "; 
        }
        elsif( $page == 4 || $top_size == 5 ) {
          $link_1 =
             "<a href=\"javascript:document.pform.action='RCASearchFormForDiffMenu';document.pform.top_size.value=40;document.pform.page.value=3;document.pform.submit()\">Expand Topography List:</A> ";
        }

     $html = $html .
        "<tr> " .
        "   <td valign=top width=25% nowrap> " .
        "     <b> <label for=\"Topography\">Topography:</label></b> " .
        "       <br> " .
        $link_1 .
        "   </td> " .
        "<td valign=top>";
        if( $page == 3 || $top_size == 40 ) {
          $html = $html .
            "<select name=tissue id=\"topography\" size=\"40\">";
        }
        elsif( $page == 4 || $top_size == 5 ) {
          $html = $html .
            "<select name=tissue id=\"topography\" size=\"5\">";
        }
        my $option;
        if( $tissue eq "All topographies" ) {
          $option = "<option selected>All topographies</option> ";
        }
        else {
          $option = "<option>All topographies</option> ";
        }
     $html = $html .
        $option .
        GetSelectMenu_2('MITELMAN_TOP', $tissue) .
        "</select> " .
        "</td>" .
        "</tr>"; 
        if( $page == 5 || $morph_size == 40 ) {
          $link_2 =
             "<a href=\"javascript:document.pform.action='RCASearchFormForDiffMenu';document.pform.morph_size.value=5;document.pform.page.value=6;document.pform.submit()\">Collapse Morphology List:</A> "; 
        }
        elsif( $page == 6 || $morph_size == 5 ) {
          $link_2 =
             "<a href=\"javascript:document.pform.action='RCASearchFormForDiffMenu';document.pform.morph_size.value=40;document.pform.page.value=5;document.pform.submit()\">Expand Morphology List:</A> ";
        }

     $html = $html .
        "  <TR> " .
        "    <TD valign=top nowrap> " .
        "        <b><label for=\"Morphology\">Morphology:</label></b> " .
        "        <br> " .
        $link_2 .
        "    </TD> " .
        "    <TD> "; 
        if( $page == 5 || $morph_size == 40 ) {
          $html = $html .
            "<select name=\"neopl\" id=\"Morphology\" size=\"40\">";
        }
        elsif( $page == 6 || $morph_size == 5 ) {
          $html = $html .
            "<select name=\"neopl\" id=\"Morphology\" size=\"5\">";
        }
        my $option_m;
        if( $neopl eq "All morphologies" ) {
          $option_m = "<option selected>All morphologies</option> ";
        }
        else {
          $option_m = "<option>All morphologies</option> ";
        }
     $html = $html .
        $option_m .
        GetSelectMenu_2('MITELMAN_MORPH', $neopl) .
        "</select> " .
        "</td>" .
        "</tr>"; 
        if( $page == 7 || $gene_size == 40 ) {
          $link_3 =
             "<a href=\"javascript:document.pform.action='RCASearchFormForDiffMenu';document.pform.gene_size.value=5;document.pform.page.value=8;document.pform.submit()\">Collapse Gene List:</A> "; 
        }
        elsif( $page == 8 || $gene_size == 5 ) {
          $link_3 =
             "<a href=\"javascript:document.pform.action='RCASearchFormForDiffMenu';document.pform.gene_size.value=40;document.pform.page.value=7;document.pform.submit()\">Expand Gene List:</A> ";
        }

     $html = $html .
        "  <TR> " .
        "    <TD valign=top nowrap> " .
        "       <b><label for=\"Gene\">Gene:</label></b><br> " .
        $link_3 .
        "    </TD> " .
        "    <TD> "; 
        my $select;
        if( $page == 7 || $gene_size == 40 ) {
          $select = 
            "<select name=\"gene\" id=\"Gene\" size=\"40\">";
        }
        elsif( $page == 8 || $gene_size == 5 ) {
          $select = 
            "<select name=\"gene\" id=\"Gene\" size=\"5\">";
        }
        my $option_g;
        if( $gene eq "All genes" ) {
          $option_g = "<option selected>All genes</option> ";
        }
        else {
          $option_g = "<option>All genes</option> ";
        }
     $html = $html .
        $select . 
        $option_g .
        GetSelectMenu_2('MITELMAN_RECURRENT_GENES', $gene) .
        "</select> " .
        "</td>" .
        "</tr>" .
        "</TABLE> " .
        ...
        "     <br><br><input type=button value=\"Reset Form\" onClick=\"parent.location='/Chromosomes/RecurrentAberrations'\">" .
        "</FORM> " .
        " " .
        "</blockquote> " .
        " " .
        "<blockquote> " .
        "<table bgcolor=ffffcc cellpadding=2> " .
        "<TR><TD>Felix Mitelman, Bertil Johansson and Fredrik Mertens,  " .
        "all of the University of Lund, Sweden, compiled the data presented  " .
        "on these Web pages with support from " .
        "the <a href=\"http://www.cancerfonden.se/\">Swedish Cancer Society</a> " .
        "and the <a href=\"http://www.barncancerfonden.se\">Swedish Children's " .
        "Cancer Foundation</a>.</TD></TR></table> " .
        "</blockquote> "; 
...
######################################################################
sub Create_new_interface_MSearch_1 {
  my (
      $base,
      $page,
      $abnorm_op,
  ...
  if( $page == 17 || $page == 18 || $page == 19 || $page == 20 || $page == 59 || $page == 60 ) {
    return BuildNewInterface_MSearch (
      $base,
      $page,
      $abnorm_op,
      $abnormality,
  ...
  elsif( $page == 21 || $page == 22 || $page == 23 || $page == 24 || $page == 79 || $page == 80 ) {
    return BuildNewInterface_CSearch (
      $base,
      $page,
      $abnorm_op,
      $abnormality,
...
sub GetMitelmanTotal_1 {
  ...
  my $sql = "select * from $CGAP_SCHEMA.MITELMAN_UPDATE_INFO";
  my $stm = $db->prepare($sql);
  if (not $stm) {
    print "<br><b><center>Error in input</b>!</center>";
    $db->disconnect();
  ...
  if( $what eq "UPDATE_DATE,TOTAL" ) {
    while ( my ($update_date, $total, $year, $total_fusions) = $stm->fetchrow_array()) {
      my $int_with_comma_total = AddCommatoInteger($total);
      my $int_with_comma_fusion = AddCommatoInteger($total_fusions);
      if( !$db->ping ) {
        $db->disconnect();
      }
      return "$update_date<BR> Total number of cases = " .
             "<font color=\"#FF0000\"><b>$int_with_comma_total</b></font><BR>" .
             ## "<font color=\"#ab0534\"><b>$int_with_comma</b></font><BR>" .
             " Total number of gene fusions = " . 
             "<font color=\"#FF0000\"><b>$int_with_comma_fusion</b></font><BR>  ";
             ##"<font color=\"#FF0000\"><b>$total_fusions</b></font><BR>  ";
             ## "<font color=\"#ab0534\"><b>706</b></font><BR>  ";
    }
  }
  elsif( $what eq "YEAR" ) {
...
sub GetCharacterlist_1 {
  ...
  my $sql = "select LINE from $CGAP_SCHEMA.MolClinGeneIndex ";
  ## print $sql . "8888<br>";
  my $stm = $db->prepare($sql);
  if (not $stm) {
  ...
  while ( my ($line) = $stm->fetchrow_array()) {
    $count++;
    my $url = 
      "<a href=\"javascript:document.pform.action='SearchFormForDiffMenu';document.pform.gene_size.value=40;document.pform.page.value=59;document.pform.startchar.value=\'$line\';document.pform.submit()\">" .
      "$line"; 
      "</a>"; 
    $output = $output . $url . ",";
    if( $count%7 == 0 ) {
...
######################################################################
sub GetSelectMenu_2 { ## for select
  ...
  if( $select eq "" ) {
    ...
    while ( my ($line) = $stm->fetchrow_array()) {
      if( $table_name =~ /MORPH$/ ) {
      ...
      elsif( $table_name =~ /MITELMAN_RECURRENT_GENES/i ) {
        if( $line =~ /\"$select\"/ ) {
          $line =~ s/<option>/<option selected>/;
        }
        elsif( $line =~ /$select/ ) {
          $line =~ s/<option>/<option selected>/;
        }
        ...
        for (my $i=0; $i<@values; $i++) {
          if( $line =~ /\"value=$values[$i]\"/i ) {
            $line =~ s/\"value=$values[$i]\"/\"value=$values[$i]\" selected/;
          }
          elsif( $line =~ /value=$values[$i]/i ) {
            $line =~ s/value=$values[$i]/value=$values[$i] selected/;
          }
        }
      }
...
######################################################################
sub GetSelectMenu_3 {  ## for check box
  my ($table_name, $select) = @_;
  ## print "8888: $table_name, $select<br>";
  my $output = "";
  my $db = DBI->connect("DBI:Oracle:" . $DB_INSTANCE,$DB_USER,$DB_PASS);
  ...
  if( $select eq "" ) {
    ...
    while ( my ($line) = $stm->fetchrow_array()) {
      ...
      for (my $i=0; $i<@values; $i++) {
        if( $line =~ /\"$values[$i]\"/ ) {
          $line =~ s/\"$values[$i]\"/\"$values[$i]\" checked/;
        }
        elsif( $line =~ /$values[$i]/ ) {
          $line =~ s/$values[$i]/$values[$i] checked/;
        }
...
######################################################################
sub BuildMCQuery_for_Gene_info {
  my (
    $page,
    $abnorm_op,
    $abnormality,
...
#   }
  ...
  if ($gene) {
    ...
    Add(
        "( " .
        DoGenePile_for_Gene_info("MolClinGene", "k", "Gene", $gene_op, @parts) .
        " )"
    );
  }
...
sub MCSearch_for_Gene_info_1 {
  ...
  my $sql = BuildMCQuery_for_Gene_info (
    $page,
    $abnorm_op,
    $abnormality,
    $author,
  ...
  my $cmd1 = "MCList_for_Gene_info?" . $cmd;
