...
sub Info_Return {
  ...
  my $output =
        ...
        ## "<BR><BR><center><a href=http://cgap-stage.nci.nih.gov/SAGE/GetUserResult?CACHE=$email&TIME=$start_time>Please wait several minutes and then click the hyper link here</a></center><br><br>" .
