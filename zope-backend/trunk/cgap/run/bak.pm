...
sub  BuildNewInterface_CSearch {
  ...
  my $html =
             ...
             $html = $html .
             "   <td align=left> " .
             "      <input type=radio name=gene_op id=\"And\" value=\"a\" $checked_a><label for=\"And\"> And</label> " .
             "      <input type=radio name=gene_op id=\"Or\" value=\"o\" $checked_b><label for=\"Or\"> Or</label> " .
             "   <br> " .
             "      <input type=\"text\" name=\"gene\" id=\"gene\" size=32 maxlength=50> " .
             "   </td> " .
             "</tr></table> " .
             "<P><B>Tumor Characteristics</B> " .
             "<table width=100% cellpadding=4> ";
