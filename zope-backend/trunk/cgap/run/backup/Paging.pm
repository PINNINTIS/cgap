...
## Comment out below to run UN-Common ##
  push @lines, "<div id='restriction' style='position:relative; visibility:visible; color:#666699; background-color:#fff5ee; font-family:monotype corsiva, garamond, verdana; font-weight:bold; width:130; height:65;'>Highlight common aspects of the listed genes</div>" ;
  push @lines, "</td>" ;
  ...
  push @lines, "<table border=5 bordercolor='#666699' cellpadding=1 cellspacing=1 bgcolor='#ffffff' style='color:#666699;'>" ;
...
##push @lines, "<input type='checkbox' name='CKBOX' value='3' onClick='javascript:checkBoxValidate(3)'>Tissues<br>" ;
  ...
  push @lines, "<a href=\"javascript:document.commonform.submit()\"><img src=\"" . IMG_DIR . "/Common/view.gif\" border=0></a>" ;
  push @lines, "</td></tr>" ;
...
##push @lines, "<input type='checkbox' name='CKBOX' value='3' onClick='javascript:checkBoxValidate(3)'" . (($ckbox =~ /3/) ? "CHECKED" : "") . ">Tissues<br>" ;
  ...
  if ($org eq "Hs") {
    ...
    push @lines, "<td><a href=\"javascript:" .
        ...
        "document.$form_name.SRC.value='SAGE_SUMMARY';" .
        "document.$form_name.submit()\">" .
        "<b>[SAGE Summary]</b></a></td>";
    push @lines, "<td><a href=\"javascript:" .
        "document.$form_name.action='$BASE/Microarray/GeneList';" .
        "document.$form_name.SRC.value='LONG_SAGE';" .
        "document.$form_name.submit()\">" .
        "<b>[LONG SAGE]</b></a></td>";
  }
  elsif ($org eq "Mm") {
  ...
  if ($num_pages > 25) {
    ...
    if ($page != 1) { 
      $s = $s . "<a href=\"javascript:document.$form_name.PAGE." .
          ...
          "<img src=\"". IMG_DIR ."/PrevPage.gif\" border=0></a>\n";
    }
    if ($page != $num_pages) {           
      $s = $s . "<a href=\"javascript:document.$form_name.PAGE." .
          "options[document.$form_name.PAGE.selectedIndex].value=" .
          ($page+1) . ";document.$form_name.submit()\">".
          "<img src=\"". IMG_DIR ."/NextPage.gif\" border=0></a>\n";
    }  
    $s = $s . "</td></tr>\n";
  } elsif ($num_pages > 1) {
