...
"<p><center><table cellspacing=2 cellpadding=2 bordercolor=#666699 border=5 frame=border rules=cols>" .
"<tr bgcolor=\"#666699\">" .
...
StartServer(PATHWAY_SERVER_PORT, "PathwayServer");
