...
sub FormatGenesWithInput {
  my ($page, $org, $cmd, $page_header, $items_ref, $garbage_ref) = @_;
  my ($good, $bad);
...
sub FormatHomoloGeneData {
  ...
  if (@rows) {
    unshift @rows, join("\n",
          "<table border=1 cellspacing=1 cellpadding=4>",
          "<tr>",
          "<td rowspan=2><font color=\"#666699\"><b>Organism</b></font></td>",
          "<td rowspan=2><font color=\"#666699\"><b>Symbol</b></font></td>",
          "<td rowspan=2><font color=\"#666699\"><b>Protein</b></font></td>",
          "<td colspan=5 align=center><font color=\"#666699\"><b>Homolog</b></font></td>",
          "<td rowspan=2><font color=\"#666699\"><b>Similarity<br>(% aa unchanged)</b></font></td>",
          "</tr>",
          "<tr>",
          "<td><font color=\"#666699\"><b>Organism</b></font></td>",
          "<td><font color=\"#666699\"><b>Symbol</b></font></td>",
          "<td><font color=\"#666699\"><b>Entrez<br>Gene</b></font></td>",
          "<td><font color=\"#666699\"><b>Gene Info</b></font></td>",
          "<td><font color=\"#666699\"><b>Protein</b></font></td>",
          "</tr>"
      );
    push @rows, "</table>";
  }
...
where
  ...
  and s.taxon_id2 = o2.taxon_id
    ...
    if(not $stm) {
      ## print STDERR "$sql\n";
      ## print STDERR "$DBI::errstr\n";
      print "<br><b><center>$sql Error in input</b>!</certer>";
      $db->disconnect();
      return "";
    }
    if(!$stm->execute()) {
...
sub BuildPIDPathwayLine {
  ...
  while ($stm->fetch) {
    $pathway_line = $pathway_line .
          ...
          "http://pid.nci.nih.gov/search/pathway_landing.shtml?pathway_id=$pidid&what=graphic&gif=on&ppage=1\")>" .
          $pidname . "</a>\n";
  }
  $stm->finish;
...
sub BuildGenePage_1 {
  ...
  if ($db) {
    ...
    ($chrom, $chrom_from, $chrom_to) = ChromPos($db, $org, $cid);
  }
...
#  &debug_print( "After run BuildHomologLine \n"); 
  ...
  my $chrom_line = "<table><tr>" .
    "<td><font color=\"#666699\"><b>Chromosomal Position</b></font>:</td>" .
    "<td>" . ($chrom ? "$chrom: $chrom_from - $chrom_to" : "Unknown") . "</td>" .
    "</tr></table>";
...
sub CountDTP {
  ...
  if ($sym) {
    $url = "http://dtp.nci.nih.gov/mtweb/servlet/hugosearch?genecard=$sym";
  } else {
...
sub ChromPos {
  ...
  $stm->bind_columns(\$chrom, \$chrom_from, \$chrom_to);

  $stm->fetch;
  $stm->finish;

  return ($chrom, $chrom_from, $chrom_to);
}
  ...
  if($page == $CLONE_PAGE) {
    ...
    return
      (FormatGenesWithInput($page, $organism, $cmd, $page_header,
       OrderGenesByInput($page, $organism, \@rows, \@tempArray), \@garbage));
  }
}
...
sub Protein_section {
  ...
  if (@np_lines) {
    ...
    if( $np2sp_flag == 1 ) {
      if ( defined %sp2ec ) {
        push @lines, "<tr>" .
          "<td width=16%><font color=\"#666699\"><b>mRNA</b></font></td>" .
          "<td width=16%><font color=\"#666699\"><b>Protein</b></font></td>" .
          "<td width=16%><font color=\"#666699\"><b>SwissProt</b></font></td>" .
          "<td width=16%><font color=\"#666699\"><b>Enzyme</b></font></td>" . 
          "<td width=16%><font color=\"#666699\"><b>Pfam Motifs</b></font></td>" .
          "</tr>";
      }
      else {
        push @lines, "<tr>" .
          "<td width=20%><font color=\"#666699\"><b>mRNA</b></font></td>" .
          "<td width=20%><font color=\"#666699\"><b>Protein</b></font></td>" .
          "<td width=20%><font color=\"#666699\"><b>SwissProt</b></font></td>" .
          "<td width=20%><font color=\"#666699\"><b>Pfam Motifs</b></font></td>" .
          "</tr>";
      }
    }
    else {
  ...
  if (@other_lines) {
    ...
    if( $non_np2sp_flag == 1 ) {
      if ( defined %sp2ec ) {
        push @lines, "<tr>" .
          "<td width=25%><font color=\"#666699\"><b>mRNA</b></font></td>" .
          "<td width=25%><font color=\"#666699\"><b>GenPept</b></font></td>" .
          "<td width=25%><font color=\"#666699\"><b>SwissProt</b></font></td>" .
          "<td width=25%><font color=\"#666699\"><b>Enzyme</b></font></td>" . 
                 "</tr>";
      }
      else {
        push @lines, "<tr>" .
          "<td width=33%><font color=\"#666699\"><b>mRNA</b></font></td>" .
          "<td width=33%><font color=\"#666699\"><b>GenPept</b></font></td>" .
          "<td width=33%><font color=\"#666699\"><b>SwissProt</b></font></td>" .
                   "</tr>";
      }
    }
    else {
