...
#Second Line
  ...
  push @rows, "<td><img src=\"$IMG_DIR/ltv_big.gif\" alt=\"big\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_$blue4\" alt=\"blue_4\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";

  push @rows, "<td><img src=\"$IMG_DIR/ltv_$pic4\" alt=\"leg_4\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_$blue3\" alt=\"blue_3\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";
    
  push @rows, "<td><img src=\"$IMG_DIR/ltv_$pic3\" alt=\"leg_3\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_$blue2\" alt=\"blue_2\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";

  push @rows, "<td><img src=\"$IMG_DIR/ltv_$pic2\" alt=\"leg_2\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_$blue1\" alt=\"blue_1\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";

  push @rows, "<td><img src=\"$IMG_DIR/ltv_$pic1\" alt=\"leg_1\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";
  push @rows, "<td><img src=\"$IMG_DIR/ltv_med.gif\" alt=\"median\"></td>";
...
#######################################
  ...
  if (defined $prot_set{"A"} or defined $prot_set{"C"} or defined $prot_set{"D"}) { 
    GetSNPInfo();
  }
...
##  push @rows, "<th>SAGEmap Info</th>";
  ...
  push @rows, "<tr>";
  push @rows, "<td align=center><img src=\"$IMG_DIR/ltv_$leg1\" alt=\"leg_1\"></td>";
...
##  push @rows, "<td align=center><a href=\"http://www.ncbi.nlm.nih.gov/SAGE/SAGEtag.cgi?tag=$tag1\">Sagemap</a></td>";
  ...
  push @rows, "<tr>";
  push @rows, "<td align=center><img src=\"$IMG_DIR/ltv_$leg2\" alt=\"leg_2\"></td>";
...
##  push @rows, "<td align=center><a href=\"http://www.ncbi.nlm.nih.gov/SAGE/SAGEtag.cgi?tag=$tag2\">Sagemap</a></td>";
  ...
  push @rows, "<tr>";
  push @rows, "<td align=center><img src=\"$IMG_DIR/ltv_$leg3\" alt=\"leg_3\"></td>";
...
##  push @rows, "<td align=center><a href=\"http://www.ncbi.nlm.nih.gov/SAGE/SAGEtag.cgi?tag=$tag3\">Sagemap</a></td>";
  ...
  push @rows, "<tr>";
  push @rows, "<td align=center><img src=\"$IMG_DIR/ltv_$leg4\" alt=\"leg_4\"></td>";
...
##########################
  ...
  push @rows, "<ul>";
  push @rows, "<li><img src=\"$IMG_DIR/ltv_est.gif\" alt=\"A_plus\"> " .
...
sub DoSNPRows {
  ...
  foreach my $tmp_snp (@{ $snp_data }) {
    ...
    push (@rows, "<td align=center>" .
        "<a href=javascript:spawn(\"http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?" .
