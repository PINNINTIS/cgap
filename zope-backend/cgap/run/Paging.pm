...
sub PageGeneList {
  ...
  goto UNCOMMON if ($page_header =~ /RNAi/);
...
## Comment out below to run UN-Common ##
  ...
  push @lines, "</th></tr>" ;
  push @lines, "<tr align=left><td style='font-size:8pt; font-weight:bold;' nowrap>";
  push @lines, "<label for=\"CytLoc\"></label><input type='checkbox' name='CKBOX' value='0' id=\"CytLoc\" onClick='javascript:checkBoxValidate(0)'>Cyt Loc<br>" ;
  push @lines, "<label for=\"Pathways\"></label><input type='checkbox' name='CKBOX' value='1' id=\"Pathways\" onClick='javascript:checkBoxValidate(1)'>Pathways<br>" ;
  push @lines, "<label for=\"Ontology\"></label><input type='checkbox' name='CKBOX' value='2' id=\"Ontology\" onClick='javascript:checkBoxValidate(2)'>Ontology<br>" ;
##push @lines, "<label for=\"Tissues\"></label><input type='checkbox' name='CKBOX' value='3' id=\"Tissues\" onClick='javascript:checkBoxValidate(3)'>Tissues<br>" ;
  push @lines, "<label for=\"Motifs\"></label><input type='checkbox' name='CKBOX' value='4' id=\"Motifs\" onClick='javascript:checkBoxValidate(4)'>Motifs<br>" ;
  push @lines, "<label for=\"SNPs\"></label><input type='checkbox' name='CKBOX' value='5' id=\"SNPs\" onClick='javascript:checkBoxValidate(5)'>SNPs<br>" ;
  push @lines, "</td>" ;
  push @lines, "</tr>" ;
...
UNCOMMON:
  ...
  push @lines, "<td>" .
      ...
      "<b>[Text]</b></a></td>";
  push @lines, "<td nowrap><a href=\"javascript:" .
      "document.$form_name.action='$action';" .
      ($num_pages > 25 ?
          ("document.$form_name.PAGE." .
  ...
  push @lines, "<td><a href=\"javascript:" .
      "document.$form_name.action='$BASE/cgapcgi/SummarizeGOForGeneSet.pl';" .
      "document.$form_name.submit()\">" .
      "<b>[GO Summary]</b></a></td>";
  push @lines, "<td nowrap>" .
      "<a href=\"javascript:" .
      "document.$form_name.action='$BASE/Genes/ChromPos';" .
      ($num_pages > 25 ?
          ("document.$form_name.PAGE." .
          "options[document.$form_name.PAGE.selectedIndex].value=0;") :
          ("document.$form_name.PAGE.value=1;")
      ) .
      "document.$form_name.submit()\">".
      "<b>[Chrom Pos]</b></a></td>";
  if ($org eq "Hs") {
    ...
    push @lines, "<td><a href=\"javascript:" .
        ...
        "document.$form_name.SRC.value='NCI60_STANFORD';" .
        "document.$form_name.submit()\">" .
        "<b>[NCI60 Stanford]</b></a></td>";
    push @lines, "<td><a href=\"javascript:" .
        "document.$form_name.action='$BASE/Microarray/GeneList';" .
        "document.$form_name.SRC.value='NCI60_NOVARTIS';" .
        "document.$form_name.submit()\">" .
        "<b>[NCI60 Affymetrix Novartis]</b></a></td>";
    push @lines, "<td><a href=\"javascript:" .
        "document.$form_name.action='$BASE/Microarray/GeneList';" .
        "document.$form_name.SRC.value='NCI60_U133';" .
        "document.$form_name.submit()\">" .
        "<b>[NCI60 Affymetrix U133]</b></a></td>";
    push @lines, "<td><a href=\"javascript:" .
        "document.$form_name.action='$BASE/Microarray/GeneList';" .
        "document.$form_name.SRC.value='SAGE_SUMMARY';" .
        "document.$form_name.submit()\">" .
        "<b>[SHORT SAGE Summary]</b></a></td>";
    push @lines, "<td><a href=\"javascript:" .
        "document.$form_name.action='$BASE/Microarray/GeneList';" .
        "document.$form_name.SRC.value='LONG_SAGE_SUMMARY';" .
        "document.$form_name.submit()\">" .
        "<b>[LONG SAGE Summary]</b></a></td>";
  }
  elsif ($org eq "Mm") {
    push @lines, "<td><a href=\"javascript:" .
        "document.$form_name.action='$BASE/Microarray/GeneList';" .
        "document.$form_name.SRC.value='UBC_SAGE';" .
        "document.$form_name.submit()\">" .
        "<b>[Mouse Atlas SAGE]</b></a></td>";
  }
SKIP_LINKS:
  push @lines, "</tr></table>";
...
sub PageCommonGeneList {
  ...
  push @lines, "<label for=\"CytLoc\"></label><input type='checkbox' name='CKBOX' value='0' id=\"CytLoc\" onClick='javascript:checkBoxValidate(0)'" . (($ckbox =~ /0/) ? "CHECKED" : "") . ">Cyt Loc<br>" ;
  push @lines, "<label for=\"Pathways\"></label><input type='checkbox' name='CKBOX' value='1' id=\"Pathways\" onClick='javascript:checkBoxValidate(1)'" . (($ckbox =~ /1/) ? "CHECKED" : "") . ">Pathways<br>" ;
  push @lines, "<label for=\"Ontology\"></label><input type='checkbox' name='CKBOX' value='2' id=\"Ontology\" onClick='javascript:checkBoxValidate(2)'" . (($ckbox =~ /2/) ? "CHECKED" : "") . ">Ontology<br>" ;
##push @lines, "<label for=\"Tissues\"></label><input type='checkbox' name='CKBOX' value='3' id=\"Tissues\" onClick='javascript:checkBoxValidate(3)'" . (($ckbox =~ /3/) ? "CHECKED" : "") . ">Tissues<br>" ;
  push @lines, "<label for=\"Motifs\"></label><input type='checkbox' name='CKBOX' value='4' id=\"Motifs\" onClick='javascript:checkBoxValidate(4)'" . (($ckbox =~ /4/) ? "CHECKED" : "") . ">Motifs<br>" ;
  push @lines, "<label for=\"SNPs\"></label><input type='checkbox' name='CKBOX' value='5' id=\"SNPs\" onClick='javascript:checkBoxValidate(5)'" . (($ckbox =~ /5/) ? "CHECKED" : "") . ">SNPs<br>" ;
  push @lines, "</th>" ;
  push @lines, "</tr>" ;
  push @lines, "<tr><td align=center>" ;
  push @lines, "<a href=\"javascript:document.commonform.submit()\"><img src=\"" . IMG_DIR . "/Common/view.gif\" alt=\"View\" border=0></a>" ;
