...
sub short_test {
  ...
  'http://cgap-dev.nci.nih.gov/SAGE/SDGEDResults?WHAT=genes&PAGE=1&FACTOR=2&CACHE=0&ORG=Hs&PVALUE=.05&CHR=All&ASEQS=0&BSEQS=0&ALIBS=2&BLIBS=2&METHOD=SS10,LS10&SDGED_CACHE=&A_14=&B_12=');
